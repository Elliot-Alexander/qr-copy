<template>
    <div class="flex flex-col space-y-2 w-full h-screen justify-center">
        <h1 class="text-4xl font-title text-center text-white">Session</h1>
        <div class="flex flex-col justify-end w-11/12 max-w-5xl h-5/6 mx-auto bg-gray-200 dark:bg-gray-800 p-4 rounded-lg shadow-lg font-body">
            ...
            <div class="flex flex-row bg-gray-100 focus-within:bg-white transition-colors ease-in-out delay-75 rounded-lg shadow-lg">
                <input type="text" class="w-full  py-2 px-1.5 focus:outline-none bg-transparent" v-model="message" @keypress.enter="sendMessage">
